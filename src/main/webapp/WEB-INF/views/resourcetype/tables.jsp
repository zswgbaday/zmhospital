                            ...
                            <div class="panel-body no-padding">
                                ...
                                <div>
                                    <form id="myform" class="form-inline" method="get" action="${cur_url}" role="form">
                                        ...
                                        <a href="${pageContext.request.contextPath}/resourcetype/add"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/resourcetype/edit?id=${item.id}"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $btn_deletes.click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/resourcetype/delete",
                type: "POST",
                datatype: "json",
                data: {
