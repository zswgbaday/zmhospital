...
<div class="app">
    ...
    <section class="layout">
        ...
        <section class="main-content">
            ...
            <%--标签头--%>
            <c:import url="resourcetypeheader.jsp"/>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body no-padding">
                                ...
                                <form id="myform" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        <label for="input_resourcetypename" class="col-sm-2 control-label">资源类型名称</label>
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control"
                                                   id="input_resourcetypename"
                                                   name="name"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        success_return_url = "${pageContext.request.contextPath}/resourcetype/list";
        </c:when>
        <c:otherwise>
        success_return_url = "${pageContext.request.contextPath}/resourcetype/edit?id=${resourcetype.id}";
        </c:otherwise>
        </c:choose>
