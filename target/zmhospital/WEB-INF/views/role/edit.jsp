                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body no-padding">
                                ...
                                <form id="myform" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        <label for="input_username" class="col-sm-2 control-label">角色名称</label>
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="radio">
                                                <label><input name="status" type="radio"
                                                              <c:if test="${role.status==1}">checked</c:if>
                                                              value="1">开</label>
                                            </div>
                                            <div class="radio">
                                                <label><input name="status" type="radio"
                                                              <c:if test="${role.status==0}">checked</c:if>
                                                              value="0">关</label>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        success_return_url = "${pageContext.request.contextPath}/role/list";
        </c:when>
        <c:otherwise>
        success_return_url = "${pageContext.request.contextPath}/role/edit?id=${role.id}";
        </c:otherwise>
        </c:choose>
