                            ...
                            <div class="panel-body no-padding">
                                ...
                                <div>
                                    <form id="myform" class="form-inline" method="get" action="${cur_url}" role="form">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/add" class="btn btn-default">新增</a>
                                    </form>
                                </div>
                                <%--列表--%>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/role/edit?id=${item.id}"
                                                                class="btn btn-info" title="修改">
                                                            <i class="fa fa-edit"></i>
                                                        </a>
                                                        <a href="${pageContext.request.contextPath}/role/grant?id=${item.id}"
                                                           class="btn btn-info" title="分配资源">
